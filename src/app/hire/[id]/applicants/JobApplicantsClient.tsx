...
export default function JobApplicantsClient({ jobId }: JobApplicantsClientProps) {
                ...
                <div
                  ...
                  className={`rounded-xl border p-6 shadow-sm transition-shadow ${
                    applicant.status === 'hired'
                      ...
                      : applicant.status === 'rejected'
                      ? 'border-red-300 bg-red-50 dark:border-red-700 dark:bg-red-900/70'
                      : 'border-green-200 bg-white dark:border-green-800 dark:bg-green-900/50'
                  }`}
                >
                  <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                      ...
                      <p className="mt-2 text-sm text-green-900/80 dark:text-green-100/80 whitespace-pre-wrap">
