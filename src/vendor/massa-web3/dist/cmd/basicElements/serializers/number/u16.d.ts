 ...
 */
export declare function toBytes(value: U16_t): Uint8Array;
/**
 ...
 */
export declare function fromBytes(bytes: Uint8Array): U16_t;
/**
 ...
 */
export declare function fromNumber(value: number): U16_t;
