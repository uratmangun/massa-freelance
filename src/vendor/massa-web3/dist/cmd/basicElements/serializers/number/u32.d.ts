 ...
 */
export declare function toBytes(value: U32_t): Uint8Array;
/**
 ...
 */
export declare function fromBytes(bytes: Uint8Array): U32_t;
/**
 ...
 */
export declare function fromNumber(value: number): U32_t;
