 ...
 */
export declare function toBytes(value: U64_t): Uint8Array;
/**
 ...
 */
export declare function fromBytes(bytes: Uint8Array): U64_t;
/**
 ...
 */
export declare function fromNumber(value: number | bigint): U64_t;
