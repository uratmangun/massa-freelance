...
const blake3_1 = tslib_1.__importDefault(require("../crypto/blake3"));
const ed25519_1 = tslib_1.__importDefault(require("../crypto/ed25519"));
...
class PrivateKey {
     ...
     */
    static initFromVersion(version = versioner_1.Version.V0) {
        switch (version) {
            case versioner_1.Version.V0:
                return new PrivateKey(new blake3_1.default(), new ed25519_1.default(), new base58_1.default(), new varintVersioner_1.default(), version);
            default:
    ...
    async sign(message) {
        ...
        return signature_1.Signature.fromBytes(this.versioner.attach(this.version, signature));
    }
    /**
...
class PublicKey {
    ...
    static initFromVersion(version = versioner_1.Version.V0) {
        switch (version) {
            case versioner_1.Version.V0:
                return new PublicKey(new blake3_1.default(), new ed25519_1.default(), new base58_1.default(), new varintVersioner_1.default(), version);
            default:
                throw new Error(`unsupported version: ${version}`);
        }
    }
     ...
     */
    getAddress() {
        return address_1.Address.fromPublicKey(this);
    }
    /**
