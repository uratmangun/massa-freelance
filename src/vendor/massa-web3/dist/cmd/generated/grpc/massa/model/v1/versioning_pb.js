...
proto.massa.model.v1.MipStatusEntry.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.massa.model.v1.MipInfo.serializeBinaryToWriter);
    }
...
proto.massa.model.v1.MipStatusEntry.prototype.getMipInfo = function () {
    return /** @type{?proto.massa.model.v1.MipInfo} */ (jspb.Message.getWrapperField(this, proto.massa.model.v1.MipInfo, 1));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.massa.model.v1.MipInfo.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            componentsList: jspb.Message.toObjectList(msg.getComponentsList(), proto.massa.model.v1.MipComponentEntry.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.massa.model.v1.MipInfo.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getStart();
    if (f != null) {
        writer.writeMessage(3, f, massa_model_v1_time_pb.NativeTime.serializeBinaryToWriter);
    }
    ...
    if (f != null) {
        writer.writeMessage(5, f, massa_model_v1_time_pb.NativeTime.serializeBinaryToWriter);
    }
    f = message.getComponentsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(6, f, proto.massa.model.v1.MipComponentEntry.serializeBinaryToWriter);
    }
};
/**
...
proto.massa.model.v1.MipInfo.prototype.getStart = function () {
    return /** @type{?proto.massa.model.v1.NativeTime} */ (jspb.Message.getWrapperField(this, massa_model_v1_time_pb.NativeTime, 3));
};
/**
...
proto.massa.model.v1.MipInfo.prototype.getActivationDelay = function () {
    return /** @type{?proto.massa.model.v1.NativeTime} */ (jspb.Message.getWrapperField(this, massa_model_v1_time_pb.NativeTime, 5));
};
/**
 * @param {?proto.massa.model.v1.NativeTime|undefined} value
 * @return {!proto.massa.model.v1.MipInfo} returns this
...
proto.massa.model.v1.MipInfo.prototype.getComponentsList = function () {
    return /** @type{!Array<!proto.massa.model.v1.MipComponentEntry>} */ (jspb.Message.getRepeatedWrapperField(this, proto.massa.model.v1.MipComponentEntry, 6));
};
/**
