import { Address, MAX_GAS_CALL, MAX_GAS_EXECUTE, MIN_GAS_CALL, parseCallArgs, populateDatastore, PublicAPI, PublicApiUrl, SmartContract, StorageCost, } from '../..';
...
export class JsonRpcProvider extends JsonRpcPublicProvider {
    client;
    account;
    ...
    async executeSC(params) {
        ...
        const operationParams = {
            ...
            expirePeriod: await getAbsoluteExpirePeriod(this.client, params.periodToLive),
    ...
    async deploy(params) {
        const coins = params.coins ?? 0n;
        const totalCost = StorageCost.smartContractDeploy(params.byteCode.length) + coins;
