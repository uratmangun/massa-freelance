import { U8, U16, U32, U64, U128, U256, arrayToBytes, bytesToArray, bytesToF32, bytesToF64, bytesToSerializableObjectArray, bytesToStr, deserializeObj, f32ToBytes, f64ToBytes, serializableObjectsArrayToBytes, strToBytes, I8, I16, I32, I64, I128, I256, } from './serializers';
/**
...
export class Args {
     ...
     */
    constructor(serialized = new Uint8Array(), offset = DEFAULT_OFFSET) {
    ...
    nextSerializable(ctor) {
        const deserializationResult = deserializeObj(this.serialized, this.offset, ctor);
    ...
    nextSerializableObjectArray(ctor) {
        ...
        const value = bytesToSerializableObjectArray(buffer, ctor);
        this.offset += length;
        return value;
    }
    /**
    ...
    nextArray(type) {
        ...
        const buffer = this.getNextData(length);
        const value = bytesToArray(buffer, type);
        this.offset += length;
        return value;
    }
    // Setter
     ...
     */
    addBool(value) {
        this.serialized = Args.concatArrays(this.serialized, U8.toBytes(value ? 1n : 0n));
        this.offset++;
