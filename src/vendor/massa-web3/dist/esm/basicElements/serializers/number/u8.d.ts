 ...
 */
export declare function toBytes(value: U8_t): Uint8Array;
/**
 ...
 */
export declare function fromBytes(bytes: Uint8Array): U8_t;
/**
 ...
 */
export declare function fromNumber(value: number): U8_t;
