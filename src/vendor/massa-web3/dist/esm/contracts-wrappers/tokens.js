...
export const TOKENS_CONTRACTS = {
    USDCe: {
        [CHAIN_ID.Mainnet.toString()]: 'AS1hCJXjndR4c9vekLWsXGnrdigp4AaZ7uYG3UKFzzKnWVsrNLPJ',
        [CHAIN_ID.Buildnet.toString()]: 'AS12k8viVmqPtRuXzCm6rKXjLgpQWqbuMjc37YHhB452KSUUb9FgL',
    },
    USDTb: {
        [CHAIN_ID.Mainnet.toString()]: 'AS12LKs9txoSSy8JgFJgV96m8k5z9pgzjYMYSshwN67mFVuj3bdUV',
        [CHAIN_ID.Buildnet.toString()]: 'AS12ix1Qfpue7BB8q6mWVtjNdNE9UV3x4MaUo7WhdUubov8sJ3CuP',
    },
    DAIe: {
        [CHAIN_ID.Mainnet.toString()]: 'AS1ZGF1upwp9kPRvDKLxFAKRebgg7b3RWDnhgV7VvdZkZsUL7Nuv',
        [CHAIN_ID.Buildnet.toString()]: 'AS12LpYyAjYRJfYhyu7fkrS224gMdvFHVEeVWoeHZzMdhis7UZ3Eb',
    },
    WETHe: {
        [CHAIN_ID.Mainnet.toString()]: 'AS124vf3YfAJCSCQVYKczzuWWpXrximFpbTmX4rheLs5uNSftiiRY',
        [CHAIN_ID.Buildnet.toString()]: 'AS1gt69gqYD92dqPyE6DBRJ7KjpnQHqFzFs2YCkBcSnuxX5bGhBC',
    },
    WETHb: {
        [CHAIN_ID.Mainnet.toString()]: 'AS125oPLYRTtfVjpWisPZVTLjBhCFfQ1jDsi75XNtRm1NZux54eCj',
        [CHAIN_ID.Buildnet.toString()]: 'AS12RmCXTA9NZaTBUBnRJuH66AGNmtEfEoqXKxLdmrTybS6GFJPFs',
    },
    PUR: {
        [CHAIN_ID.Mainnet.toString()]: 'AS133eqPPaPttJ6hJnk3sfoG5cjFFqBDi1VGxdo2wzWkq8AfZnan',
    },
    POM: {
        [CHAIN_ID.Mainnet.toString()]: 'AS1nqHKXpnFXqhDExTskXmBbbVpVpUbCQVtNSXLCqUDSUXihdWRq',
    },
    WMAS: {
        [CHAIN_ID.Mainnet.toString()]: 'AS12U4TZfNK7qoLyEERBBRDMu8nm5MKoRzPXDXans4v9wdATZedz9',
        [CHAIN_ID.Buildnet.toString()]: 'AS12FW5Rs5YN2zdpEnqwj4iHUUPt9R4Eqjq2qtpJFNKW3mn33RuLU',
    },
    WBTCe: {
        [CHAIN_ID.Mainnet.toString()]: 'AS12fr54YtBY575Dfhtt7yftpT8KXgXb1ia5Pn1LofoLFLf9WcjGL',
        [CHAIN_ID.Buildnet.toString()]: 'AS1ZXy3nvqXAMm2w6viAg7frte6cZfJM8hoMvWf4KoKDzvLzYKqE',
    },
};
