import { Address, EventFilter, ExecuteSCReadOnlyParams, ExecuteSCReadOnlyResult, Network, SmartContract } from '..';
import { Mas } from '../basicElements/mas';
import { Operation, OperationOptions, OperationStatus } from '../operation';
import { rpcTypes as t } from '../generated';
import { CallSCParams, DeploySCParams, SignedData, ExecuteScParams, SignOptions, NodeStatusInfo, ReadSCData, ReadSCParams } from './';
...
export type Provider = PublicProvider & {
    ...
    sign(data: Uint8Array | string, signOptions?: SignOptions): Promise<SignedData>;
