import { DEFAULT_MAX_ARGUMENT_ARRAY_SIZE, DEFAULT_GET_DATASTORE_KEYS_PAGE_SIZE, } from '../provider/constants';
 ...
 */
export async function getMultipleAddressesDatastoreKeys(client, params) {
    ...
    while (toContinue) {
        ...
        const batchedIndices = toBatch(activeIndices, DEFAULT_MAX_ARGUMENT_ARRAY_SIZE);
        // Process each batch
