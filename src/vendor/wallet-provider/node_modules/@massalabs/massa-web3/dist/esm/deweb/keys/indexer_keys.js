 ...
 * @returns The base key for the owner's address
 */
export function addressToOwnerBaseKey(address) {
...
export function addressToOwnerKey(address, owner) {
 ...
 * @returns The base key for the owner's list of websites
 */
export function indexByOwnerBaseKey(owner) {
...
export function indexByOwnerKey(owner, address) {
