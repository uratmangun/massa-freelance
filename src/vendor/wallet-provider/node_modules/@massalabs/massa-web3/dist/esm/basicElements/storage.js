...
export async function MRC20BalanceCreationCost(provider, tokenAddress, recipient) {
    let cost = 0n;
    const balanceKeyPrefix = 'BALANCE';
    const balanceKey = balanceKeyPrefix + recipient;
    const [actualRecipientBalance] = await provider.readStorage(tokenAddress, [balanceKey], false);
