 ...
 */
export declare function fromMas(value: U64_t): Mas;
/**
 ...
 * @throws An error if the value is not a safe integer.
 */
export declare function fromMilliMas(value: U64_t): Mas;
/**
 ...
 * @throws An error if the value is not a safe integer.
 */
export declare function fromMicroMas(value: U64_t): Mas;
/**
 ...
 * @throws An error if the value is not a safe integer.
 */
export declare function fromNanoMas(value: U64_t): Mas;
/**
